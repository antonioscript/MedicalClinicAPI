...
namespace MedicalClinic.Application.Features.Insurances.Commands
{
    public class DeleteInsuranceCommand : IRequest<Result<int>>
    {
        ...
        public class DeleteCompetitorCompanyCommandHandler : IRequestHandler<DeleteInsuranceCommand, Result<int>>
        {
            private readonly IInsuranceRepository _repository;
            private readonly IUnitOfWork _unitOfWork;

            public DeleteCompetitorCompanyCommandHandler(IInsuranceRepository repository, IUnitOfWork unitOfWork)
            {
